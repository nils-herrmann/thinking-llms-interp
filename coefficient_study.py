...
if "8b" in args.model.lower():
    pos_coefficients = [0.5, 0.75, 1, 1.25, 1.5]  # Positive steering coefficients
    neg_coefficients = [0.5, 0.75, 1, 1.25, 1.5]  # Negative steering coefficients
