...
def plot_results(results, model_name):
    ...
    plt.tight_layout()
    plt.savefig(f'figures/gsm8k_results_{model_id}.pdf', dpi=300, bbox_inches='tight')
    plt.show()
    plt.close()
...
# %% Load GSM8K dataset
test_dataset = load_dataset("HuggingFaceH4/MATH-500", "test", streaming=True).shuffle(seed=42)
...
# %% Save results
with open(f'data/gsm8k_evaluation_results_{model_id}.json', 'w') as f:
